...
class ControladorProductos{
	...
	static public function ctrMostrar($item, $valor){
		...
		$respuesta = ModeloProductos::mdlMostrar($tabla, $item, $valor);
	...
	static public function ctrMostrarProductosRe($item, $valor, $orden){

		$tabla = "articulos";

		$respuesta = ModeloProductos::mdlMostrarProductosRe($tabla, $item, $valor, $orden);
